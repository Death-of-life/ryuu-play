...
function getCard(name: string) {
  const card = setFgh.find(c => c.name === name);
...
describe('override normalization set_fgh', () => {
  it('replaces full-art rare candy variants with zero-width characters in their names', () => {
    const rareCandy = setFgh.find(card => card.fullName === '‌神奇糖果 231/SV-P#17368');
...
describe('Energy Search set_fgh', () => {
...
describe('Qian Jin Xiao Jie set_fgh', () => {
...
describe('Shen Ao De Huo Ban set_fgh', () => {
...
describe('Hisuian Heavy Ball set_fgh', () => {
...
describe('Counter Catcher set_fgh', () => {
...
describe('Sparkling Crystal set_fgh', () => {
...
describe('Forest Seal Stone set_fgh', () => {
