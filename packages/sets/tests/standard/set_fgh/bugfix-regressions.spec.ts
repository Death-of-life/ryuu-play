...
import { Artazon } from '../../../src/standard/set_fgh/artazon';
import { BraveryCharm } from '../../../src/standard/set_fgh/bravery-charm';
import { DoubleTurboEnergy } from '../../../src/standard/set_fgh/double-turbo-energy';
import { HuiLiBiaoEnergy } from '../../../src/standard/set_fgh/hui-li-biao-energy';
import { JetEnergy } from '../../../src/standard/set_fgh/jet-energy';
...
import { VGuardEnergy } from '../../../src/standard/set_fgh/v-guard-energy';
import { ZhongLiZhongXin } from '../../../src/standard/set_fgh/zhong-li-zhong-xin';
...
describe('set_fgh bugfix regressions', () => {
  it('lets 奇鲁莉安 use 精炼', () => {
  ...
  it('uses real special energy implementations in setFgh and applies 双重涡轮效果', () => {
